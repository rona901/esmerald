...
def create_client(
    routes: APIGateHandler | List[APIGateHandler],
    *,
    settings_module: SettingsType | None | str | None = None,
    ...
    secret_key: str | None = get_random_secret_key(),
    ...
    pluggables: Dict[str, Pluggable] | None = None,
    ...
    on_shutdown: List[LifeSpanHandler] | None = None,
    on_startup: List[LifeSpanHandler] | None = None,
    ...
    openapi_version: str | None = "3.1.0",
    raise_server_exceptions: bool = True,
    root_path: str = "",
    static_files_config: StaticFilesConfig | None = None,
    template_config: TemplateConfig | None = None,
    lifespan: Callable[[Esmerald], AsyncContextManager] | None = None,
    cookies: CookieTypes | None = None,
    redirect_slashes: bool | None = None,
    tags: List[str] | None = None,
    webhooks: Sequence[WebhookGateway] | None = None,
